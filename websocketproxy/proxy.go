...
func (w *WebsocketProxy) ServeHTTP(rw http.ResponseWriter, req *http.Request) {
	...
	if strings.HasPrefix(backendURL.String(), "wss") && req.TLS == nil {
	...
	if req.TLS != nil || backendURL.Scheme == "wss" {
	...
	connBackend, resp, err := dialer.Dial(backendURL.String(), http.Header{})
	if err != nil {
